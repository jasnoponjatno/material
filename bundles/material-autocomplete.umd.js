...
var MatAutocomplete = (function () {
    ...
    MatAutocomplete.propDecorators = {
        ...
        'setLastWord': [{ type: _angular_core.Input },],
...
var MatAutocompleteTrigger = (function () {
    ...
    MatAutocompleteTrigger.prototype._setValueAndClose = function (event) {
        if (event && event.source) {
            ...
            var /** @type {?} */ value = event.source.value;
            if (this.autocomplete.setLastWord) {
                var /** @type {?} */ splittedValue = this._element.nativeElement.value.trim().split(' ');
                splittedValue[splittedValue.length - 1] = value;
                var /** @type {?} */ newValue = splittedValue.join(' ');
